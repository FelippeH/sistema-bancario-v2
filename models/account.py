...
class Account:
    ...
    # decorador para limitar transações diárias
    @transaction_limit(max_transactions=15)
...
# criação da conta corrente com verificação de limite de quantidade e valor de saques.
...
class CheckingAccount(Account):
    ...
    def withdrawal(self, value):
        num_withdrawals = len(
            [
                transaction
                for transaction in self.history._transactions
